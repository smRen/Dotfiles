...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; (default nil)
   dotspacemacs-initial-scratch-message "Welcome hacker."
